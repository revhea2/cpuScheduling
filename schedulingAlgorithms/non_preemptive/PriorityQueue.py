...
class PriorityQueue:
    ...
    def perform_priority_queue(self, processes):
        ...
        while True:
            ...
            while n >= 0:
                ...
                process = NpProcess(process.name, time, process.burst_time, current_burst_time=process.burst_time, priority=process.priority)
